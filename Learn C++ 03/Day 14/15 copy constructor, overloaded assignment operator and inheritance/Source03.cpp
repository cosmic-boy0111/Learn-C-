...
int main() {
	Derived u; // invokes default constructor of Derived class
	Derived v = u; // invokes copy constructor of Derived class
	v = u; // invokes copy assignment operator of Derived class
}
